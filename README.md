...
Можно получить значение изменяемой величины на совершенно любой момент времени и оно всегда будет точным. Но это же вызывает проблему с обработкой (к примеру хранением) аналогового сигнала - в зависимости от его характера это может быть сложно или невозможно.  
