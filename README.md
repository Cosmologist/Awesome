...
**Дискретизация** - получение значений непрерывной функции с заданной частотой (через интервалы фиксированного размера) - прерывание непрерывной функции. Размер промежутка определяется **частотой дискретизации**.  
