...
![Catch the global exception](//github.com/Cosmologist/Awesome/blob/master/images/phpstorm-global-exception-breakpoint.png?raw=true" alt="phpstorm-global-exception-breakpoint.png) "Disable breakpoint until is hit" option value must be *Any* to skip any other exception declared here.  
